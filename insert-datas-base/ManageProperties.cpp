...
namespace Manage
{
       ...
       void ManageProperties::display_map_properties()
       {
                    ...
                    {
                          cout << endl << "key : " <<itr->first << endl << "Value : " << itr->second << endl;
                    }
       }
       ...
       void ManageProperties::delete_value_by_key(string key)
       {
                     ...
                     {
                            cout << "Cle : " << key << endl;
                            cout << endl <<"Suppression impossible, la cle n'existe pas dans map_properties";
                     }
       }
       ...
       {
                     if (key.length() == 0) {
                            cout << endl <<"Ajout impossible, la cle n'est n'est pas renseignee : " << key << endl;
                            return ;
                     }
                     if (value.length() == 0) {
                            cout << endl <<"Ajout impossible, la valeur n'est n'est pas renseignee : " << value <<  endl;
                            return ;
                     }
                     ...
                     {
                            cout << "Cle " << key << endl;
                            cout << "Ajout impossible, la cle existe dans map_properties " << key << endl;
                     }
       }
