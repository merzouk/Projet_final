...
public:
    ...
    */
    ...
    //GenericValue& SetString(std::string s) { this->~GenericValue(); s; return *this; }
    ...
    */
    ...
    GenericValue& SetString(std::string  s, Allocator& allocator) { return SetString(s, allocator); }
